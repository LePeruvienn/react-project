	...
	return (
		<nav className="text-white z-10 fixed top-0 font-sans flex flex-row justify-between py-4 px-52 absolute bg-transparent shadow w-full">
			...
			<div className="w-120 flex flex-row justify-between items-center">
				<a href="/home" className="text-lg text-grey-darkest hover:text-red-500">
					Home
				</a>
				<a href="/book" className="text-lg text-grey-darkest hover:text-red-500">
					Book
				</a>
				<a href="/blog" className="text-lg text-grey-darkest hover:text-red-500">
					Blog
				</a>
				<a href="/about" className="text-lg text-grey-darkest hover:text-red-500">
					About
				</a>
				<a href="/contact" className="text-lg text-grey-darkest hover:text-red-500">
					Contact
				</a>
